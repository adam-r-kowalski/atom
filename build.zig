...
pub fn build(b: *std.build.Builder) void {
    ...
    const pulse = b.createModule(.{ .source_file = .{ .path = "src/pulse.zig" } });
    ...
    const path = if (file) |f| f else "test/test_pulse.zig";
    ...
    unit_tests.addModule("pulse", pulse);
