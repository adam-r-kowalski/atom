...
const RED = orca.error_reporter.pretty_print.RED;
const CLEAR = orca.error_reporter.pretty_print.CLEAR;
...
test "use of undefined variable" {
    ...
    const source =
        ...
        \\}
    ;
    const actual = try orca.testing.compileErrors(allocator, source);
