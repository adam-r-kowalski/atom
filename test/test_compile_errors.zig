...
const RED = pulse.error_reporter.pretty_print.RED;
const CLEAR = pulse.error_reporter.pretty_print.CLEAR;
...
test "use of undefined variable" {
    ...
    const source =
        ...
        \\}
    ;
    const actual = try pulse.testing.compileErrors(allocator, source);
