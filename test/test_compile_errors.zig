...
const RED = rocket.error_reporter.pretty_print.RED;
const CLEAR = rocket.error_reporter.pretty_print.CLEAR;
...
test "use of undefined variable" {
    ...
    const source =
        ...
        \\}
    ;
    const actual = try rocket.testing.compileErrors(allocator, source);
